...
namespace Ast {
    ...
    AstNode::AstNode (AstTypeId astTypeId) : parent (nullptr), trueBranch (nullptr), falseBranch (nullptr),
                                             breakBlock (nullptr), continueBlock (nullptr), typeId (astTypeId) {}
    ...
    ConstantAst::ConstantAst (double constant) : AstNode (AstTypeId::CONSTANT), constantValue (constant) {}
    ...
    BreakAst::BreakAst () : AstNode (AstTypeId::BREAK) {}

    //--------------------------------------------------------------------------------------------------------------------------------
    //------------------------------------------------------------BreakAst------------------------------------------------------------
    //--------------------------------------------------------------------------------------------------------------------------------

    ContinueAst::ContinueAst () : AstNode (AstTypeId::CONTINUE) {}
}
